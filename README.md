# FMCG (Fast- Moving Consumer Goods) Sales Performance Dashboard
# Objective :
To design an interactive FMCG (Fast- Moving consumer Goods) Sales Performance Dashboard in Power BI Desktop that helps sales and Marketing teams monitor.
